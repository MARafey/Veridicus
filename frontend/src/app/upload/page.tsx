    ...
    <main style={{ maxWidth: 560, margin: "0 auto", padding: "48px 24px" }}>
      ...
      <GlassCard variant="elevated" style={{ padding: 40 }}>
        {!uploaded ? (
          ...
          <>
            <Title level={3} style={{ color: "var(--text-primary)", textAlign: "center", marginBottom: 4 }}>
              Analysing Resume
            </Title>
            <Text style={{ color: "var(--text-muted)", display: "block", textAlign: "center", marginBottom: 8 }}>
